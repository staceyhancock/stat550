...
3. **Project** (15%): Each student will dive into one mathematical statistics journal article of your choice this semester. The project will include a written "executive summary", a proof sketch of one of the derivations in the article, and an 10-12 minute presentation of the article during the last week of classes. Detailed project instructions and deadlines will be available in Canvas.
